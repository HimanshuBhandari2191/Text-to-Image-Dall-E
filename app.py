...
st.markdown("""
    <svg width="600" height="100">
        <text x="50%" y="50%" font-family="bolditalic" font-size="50px" fill="black" text-anchor="middle" stroke="white"
         stroke-width="0.5" stroke-linejoin="round">Image Generator AI
        </text>
    </svg>
